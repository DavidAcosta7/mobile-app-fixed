-- ============================================================================
-- FLUXPAY COMPLETE DATABASE SCHEMA
-- Script SQL completo para crear/recrear todas las tablas en Supabase PostgreSQL
-- ============================================================================
-- 
-- Este script:
...
-- Eliminar políticas RLS existentes si existen (se recrearán después)
...
-- Eliminar función de trigger si existe (se recreará)
